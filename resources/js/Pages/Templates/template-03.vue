    ...
    <WeddingTemplateLayout :color="props.options.containerColor" :partials="partials" :navigation="props.navigation"
        ...
        <template #location>
            <div class="space-y-10 p-10">
                ...
                <div class="flex flex-col items-center font-merienda text-sm text-center fade-in">
                    <p class="my-2 text-3xl font-dancing" :style="{ color: props.options.primaryColor }">Lokasi</p>
                    <p class="text-sm" :style="{ color: props.options.secondaryColor }">
                        {{ location }}
                    </p>
                    <button class="mt-5 px-4 py-2 rounded-full text-black font-semibold text-xs"
                        :style="{ backgroundColor: props.options.primaryColor }">Buka Google Maps</button>
                </div>
            </div>
        </template>
        <!-- End Location -->
        ...
        <template #event>
            <div class="space-y-10 p-10">
                ...
                <div class="flex flex-col items-center font-merienda text-sm text-center fade-in">
                    ...
                    <p class="text-xl" :style="{ color: props.options.secondaryColor }">
                        {{ props.location }}
                    </p>
                </div>
