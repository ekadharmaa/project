...
const sidebarMenu = store.memberMenu;
</script>
...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex items-center">
                            ...
                            <!-- Navigation Links -->
                            <div
                                class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex font-semibold text-neutral-700"
                            >
                                <slot name="header" />
                            </div>
                        </div>
            ...
            <div class="flex pt-16 px-2 lg:px-0">
                <!-- Sidebar -->
                <Sidebar v-model="showSidebar.value" :menu="sidebarMenu" />

                <div
                    class="w-full"
                    :class="{
                        'lg:pl-[4.5rem]': !showSidebar.value,
                        'lg:pl-64': showSidebar.value,
                    }"
                >
                    <!-- Page Content -->
                    <main>
